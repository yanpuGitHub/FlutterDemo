...
class ExpandableTextState extends State<ExpandableText> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.style == null || widget.style?.inherit == true) {
    ...
    final prefixText = widget.prefixText != null && widget.prefixText?.isNotEmpty == true ? '${widget.prefixText} ' : '';
    ...
    final link = TextSpan(
      children: [
        ...
        if (linkText.isNotEmpty) TextSpan(
          style: effectiveTextStyle,
          children: <TextSpan>[
            if (_expanded) const TextSpan(
              text: ' ',
            ),
            TextSpan(
              text: linkText,
